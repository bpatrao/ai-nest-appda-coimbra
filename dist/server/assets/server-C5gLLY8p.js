...
import { createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, executeRewriteInput, invariant, isNotFound, isRedirect, isResolvedRedirect, makeSerovalPlugin, resolveManifestAssetLink, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-ClfHccRk.js");
